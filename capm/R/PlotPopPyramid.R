...
#' 
#' \code{xlabels} and \code{ylabels} can be interpereted as refering to the horizontal and vertical axis respectively. However, because the plot is a rotated barplot, \code{PlotPopPyramid} internally uses \code{xlabels} as an argument to the y-axis and \code{ylabels} to the x-axis. 
#' 
...
#' pyram <- PlotPopPyramid(Sample, col.age = 5, col.sex = 4, col.cas = 6)
...
#' pyram
#'
PlotPopPyramid <- function(dat = NULL, col.age = NULL, col.sex = NULL, col.cas = NULL, xlabel = 'Percentage', ylabel = 'Age category', innercolor = 'Gold2', outercolor = 'DarkOliveGreen') {
