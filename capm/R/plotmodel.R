...
#' 
#' For \code{\link{sterowned}} function: 
#' 
#' "n" (population size).
#' 
#' "q" (proportion of sterilized animals). 
#' 
#' For \code{\link{rasa}} function using with only point estimates:
#' 
...
#' "N" (total population).
#' 
#' For \code{\link{rasa}} function using *.range arguments:
#' 
#' "f" (intact females).
#' 
...
#' @param scenlabel string with the name of scenarios of \code{\link{rasa}} output, determined by the immigartion rates. Within the string, use the expression __ in the location where you want to appear the value of the immigartion rate. For line breaking, use \code{\\n} (see examples).
#' @param pop a value indicating the output of \code{\link{rasa}} to be ploted. When \code{NULL} (default), plots for owned and stray populations under scenarios created by immigartion rate are created. If \code{1}, the plots of owned population for the minimum immigartion rate are ploted. When \code{2}, the plots of stray population for the minimum immigartion rate are ploted. If \code{3}, the plots of owned population for the maximum immigartion rate are ploted. When \code{4}, the plots of owned population for the maximum immigartion rate are ploted.
...
#'
plotmodel = function(model.out = NULL, variable = NULL, col = 'red', col1 = c('cadetblue1', 'yellow', 'red'), col2 = c('blue', 'darkgreen', 'darkred'), xlabel = 'Time', scenlabel = 'Imm = (__ * owned carrying capacity)', leglabel = NULL, ylabel = NULL, pop = NULL) {
