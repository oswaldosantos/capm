...
#' # Guía rápida de programación con capm 0.4 en R versión 3.0.3
...
#' - Versiones R 3.0.2 y RStudio 0.98.501. 
...
#'  * santos.shx
#'  * survey.data.csv
#'  En el enlace anterior también encontrará un archivo llamado guia_rapida_de_programacion_capm_0.3.2.R con los códigos de esta guía.
